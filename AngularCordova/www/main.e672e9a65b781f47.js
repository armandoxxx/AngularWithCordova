    ...
    initPush() {
        ...
        PushNotification.hasPermission(() => {
            ...
            push.on('notification', (data) => {
                me.messages.push("user topic subscribed");
                console.log(data);
            });
            push.on('error', (data) => {
                console.log(data);
...
AppComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 16, vars: 1, consts: [["mat-button", "", "routerLink", "/camera", "routerLinkActive", "active"], ["mat-button", "", "routerLink", "/data", "routerLinkActive", "active"], ["mat-button", "", "routerLink", "/notify", "routerLinkActive", "active"], [1, "pages"], [4, "ngFor", "ngForOf"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
//# sourceMappingURL=main.e672e9a65b781f47.js.map